...
User.findAll( { include : [{ model : User, separate : true, include : [User, { model : User, as : 'residents' }] }] } );
User.findAll( { include : [{ model : User, separate : true, order : [['username', 'ASC']], include : [User, { model : User, as : 'residents' }] }] } );
User.findAll( { include : [{ model : User, separate : true, limit : 10, include : [User, { model : User, as : 'residents' }] }] } );
